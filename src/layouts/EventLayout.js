...
class EventLayout extends React.PureComponent {
  ...
  getPageTitle() {
    ...
    if (currRouterData && currRouterData.name) {
      ...
      // console.log(currRouterData.name);
      title=intl.formatMessage({id:'event.menu.'+currRouterData.name})+' - Deloitte';
    }
    return title;
  }
  ...
  render() {
    ...
    const layout = (
      <Layout>
        ...
        <Layout style={{background:'#3990bf',minHeight:window.innerHeight-64}}>
          <SiderMenu
          logo={logo}
          ...
          onCollapse={this.handleMenuCollapse}
         />
          <Content style={{minHeight:'100%', borderRadius:'18px 18px 0 0',background:'#fff'}}>
            <Switch>
