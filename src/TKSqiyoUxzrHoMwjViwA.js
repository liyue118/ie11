! function(t) {
    ...
    r.init = function(t, e) {
      ...
      return e && (r = {
        payload: e
      }), this.options = c.merge(n, t, r), this.client.configure(t, e), this.instrumenter.configure(t), this
      ...
      try {
        ...
        if (!t._rollbar_wrapped && (t._rollbar_wrapped = function() {
            ...
            try {
              ...
              var e = n;
              throw e && (c.isType(e, "string") && (e = new String(e)), e._rollbarContext = r() || {}, e._rollbarContext._wrappedSource = t.toString(), window._rollbarWrappedError = e), e
            }
    ...
    function r(t, e, n, o) {
      this.options = u.merge(t), this.logger = n, r.rateLimiter.configureGlobal(this.options), r.rateLimiter.setPlatformOptions(o, this.options), this.queue = new i(r.rateLimiter, e, n, this.options), this.notifier = new a(this.queue, this.options), this.telemeter = new s(this.options), this.lastError = null
    }
    var o = n(3),
      i = n(4),
      a = n(8),
    ...
    r.rateLimiter = new o(c), r.prototype.global = function(t) {
      ...
      return e && (r = {
        payload: e
      }), this.options = u.merge(n, t, r), this.global(this.options), this
    ...
    function n() {
      ...
      for (t = 0; t < c; t++)
        if (u = arguments[t], null != u)
          for (a in u) e = s[a], r = u[a], s !== r && (r && i(r) ? (o = e && i(e) ? e : {}, s[a] = n(o, r)) : "undefined" != typeof r && (s[a] = r));
      return s
    }
    ...
    function r(t, e, n, r) {
      t._rollbarWrappedError && (r[4] || (r[4] = t._rollbarWrappedError), r[5] || (r[5] = t._rollbarWrappedError._rollbarContext), t._rollbarWrappedError = null), e.handleUncaughtException.apply(e, r), n && n.apply(t, r)
    }
    ...
    function a(t) {
      return function(e, n, r) {
        ...
        var o = "$remote_ip";
        n.captureIp ? n.captureIp !== !0 && (o += "_anonymize") : o = null, h.set(e, "data.request", {
          url: t.location.href,
    ...
    function i(t, e, n, r, o) {
      ...
      t.enabled === !1 || i === !1 ? this.autoInstrument = {} : (a.isType(i, "object") || (i = c), this.autoInstrument = a.merge(c, i)), this.scrubTelemetryInputs = !!t.scrubTelemetryInputs, this.telemetryScrubber = t.telemetryScrubber, this.telemeter = e, this.rollbar = n, this._window = r || {}, this._document = o || {}, this.replacements = {
        network: [],
        log: [],
        navigation: [],
        connectivity: []
    ...
    i.prototype.configure = function(t) {
      ...
      t.enabled === !1 || e === !1 ? this.autoInstrument = {} : (a.isType(e, "object") || (e = c), this.autoInstrument = a.merge(c, e)), this.instrument(n), void 0 !== t.scrubTelemetryInputs && (this.scrubTelemetryInputs = !!t.scrubTelemetryInputs), void 0 !== t.telemetryScrubber && (this.telemetryScrubber = t.telemetryScrubber)
